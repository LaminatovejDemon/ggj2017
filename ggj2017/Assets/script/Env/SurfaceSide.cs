...
public class SurfaceSide : SurfacePlane {
	...
	protected sealed override void CalculateUV(int index){
		_uvs [index * 4 + 0] = new Vector2(_vertices [index * 4 + 0].z, _vertices [index * 4 + 0].y * 2);
		_uvs [index * 4 + 1] = new Vector2(_vertices [index * 4 + 1].z, _vertices [index * 4 + 1].y * 2);
		_uvs [index * 4 + 2] = new Vector2(_vertices [index * 4 + 2].z, _vertices [index * 4 + 2].y * 2);
		_uvs [index * 4 + 3] = new Vector2(_vertices [index * 4 + 3].z, _vertices [index * 4 + 3].y * 2);
	}
